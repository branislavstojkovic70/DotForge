...
const mockGrants: GrantDetail[] = [
  ...
  },
  {
    ...
    description:
      "Audited library of EVM precompiles exposing Substrate pallets (staking, governance, XCM) to Solidity.",
    ...
    progress: 50,
    milestones: [
      { id: "m1", title: "Core staking precompiles", amount: 5000, completed: true },
      { id: "m2", title: "Governance & XCM precompiles", amount: 5000, completed: false },
      { id: "m3", title: "Audit & deployment", amount: 5000, completed: false },
    ],
    teamSize: 4,
    appliedAt: "Jan 2026",
    deadline: "Sep 2026",
  ...
  {
    id: "grant-9",
    title: "Astar Cross-VM Bridge",
    description:
      "Native messaging layer between Wasm (ink!) and Solidity contracts on Astar with reference dApps.",
    ...
    progress: 30,
    milestones: [
      { id: "m1", title: "Messaging protocol", amount: 3300, completed: true },
      { id: "m2", title: "Reference dApps", amount: 4400, completed: false },
      { id: "m3", title: "Docs & release", amount: 3300, completed: false },
    ],
    teamSize: 3,
    appliedAt: "Feb 2026",
    deadline: "Nov 2026",
  },
  {
    ...
    description:
      "Smart-order router with simulation APIs and LP incentives for the Hydration Omnipool.",
    organization: "Hydration DAO",
    organizationColor: "#FF7043",
    category: "DeFi",
    status: "Under Review",
    amountRequested: 6800,
    amountPaid: 5100,
    currency: "DOT",
    progress: 80,
    milestones: [
      { id: "m1", title: "Router core", amount: 2000, completed: true },
      { id: "m2", title: "Simulation API", amount: 1800, completed: true },
      { id: "m3", title: "LP incentives", amount: 1300, completed: true },
      { id: "m4", title: "Security review", amount: 1700, completed: false },
    ],
    teamSize: 3,
    appliedAt: "Dec 2025",
    deadline: "Jun 2026",
  ...
  {
    id: "grant-11",
    title: "Talisman Signet Policies",
    description:
      "Policy engine for Talisman Signet multisigs with rule-based signing, time locks and team roles.",
    organization: "Talisman Studio",
    organizationColor: "#D84315",
    category: "Tooling",
    status: "Active",
    amountRequested: 9400,
    amountPaid: 2350,
    currency: "DOT",
    progress: 25,
    milestones: [
      { id: "m1", title: "Rule DSL", amount: 2350, completed: true },
      { id: "m2", title: "Time locks & roles", amount: 3525, completed: false },
      { id: "m3", title: "UI & docs", amount: 3525, completed: false },
    ],
    teamSize: 3,
    appliedAt: "Mar 2026",
    deadline: "Nov 2026",
  ...
  {
    id: "grant-12",
    title: "OpenGov Delegation Graph",
    description:
      "Interactive delegation graph and analytics for OpenGov referenda with historical playback.",
    ...
    progress: 35,
    milestones: [
      { id: "m1", title: "Indexer", amount: 1800, completed: true },
      { id: "m2", title: "Graph UI", amount: 1800, completed: false },
      { id: "m3", title: "Historical playback", amount: 1800, completed: false },
    ],
    teamSize: 2,
    appliedAt: "Feb 2026",
    deadline: "Aug 2026",
  ...
  {
    id: "grant-13",
    title: "Light Client Research",
    description:
      "Formal analysis of light client security assumptions and browser-side proof verification.",
    ...
    progress: 100,
    milestones: [
      { id: "m1", title: "Security model", amount: 4000, completed: true },
      { id: "m2", title: "Browser prover", amount: 5000, completed: true },
      { id: "m3", title: "Final report", amount: 5000, completed: true },
    ],
    teamSize: 4,
    appliedAt: "Jun 2025",
    deadline: "Jan 2026",
  ...
  {
    id: "grant-14",
    title: "Ink! Security Auditor",
    description:
      "Static analysis engine for ink! contracts with rules for common vulnerabilities and gas abuse.",
    organization: "Substrate Labs",
    organizationColor: "#58AD95",
    category: "Tooling",
    status: "Active",
    ...
    progress: 55,
    milestones: [
      { id: "m1", title: "Rule engine", amount: 2400, completed: true },
      { id: "m2", title: "Vulnerability rules", amount: 2400, completed: true },
      { id: "m3", title: "CI integration", amount: 2400, completed: false },
    ],
    teamSize: 3,
    appliedAt: "Jan 2026",
    deadline: "Aug 2026",
  ...
  {
    id: "grant-15",
    title: "XCM Simulator Suite",
    description:
      "High-fidelity XCM simulator for relay chains, bridge hubs and parachains with deterministic replay.",
    organization: "XCM Workshop",
    organizationColor: "#64B5F6",
    category: "Tooling",
    status: "Draft",
    amountRequested: 6300,
    amountPaid: 0,
    currency: "DOT",
    progress: 0,
    milestones: [
      { id: "m1", title: "Simulator core", amount: 2100, completed: false },
      { id: "m2", title: "Replay harness", amount: 2100, completed: false },
      { id: "m3", title: "Docs & examples", amount: 2100, completed: false },
    ],
    teamSize: 2,
    appliedAt: "Apr 2026",
    deadline: "Dec 2026",
